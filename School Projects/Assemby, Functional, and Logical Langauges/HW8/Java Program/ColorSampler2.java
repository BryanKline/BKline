...
public class ColorSampler extends JFrame 
{
    ...
    //class constructor
    public ColorSampler(String title) throws AWTException
	{
        ...
        colorList.setSelectionInterval(0, 0);

        //action handler listeners set for buttons and list
        ...
        //set default color 
        //NOTE: this was added just before submitting electronically, not on paper copy, causes the 
        //grahpic to start off red by default instead of black
		...
		public void fileWriter() throws IOException
   	    {    
            ...
            for(row = 0; row < 11; row++)
            {
                ...
                for(column = 0; column < 3; column++)
                {
                    streamWriter.print(colors[row][column] + " ");
                }
